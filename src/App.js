...
// import loadable from './element/Common/loader/loadable';
// import Loading from './element/Common/loader';
...
// const ScrollToTop = loadable(() => pMinDelay(import('./element/Common/ScrollToTop'), 250), { fallback: <Loading /> });
...
//             <Route path='/email-template-three' element={EmailTemplateThrees} />
...
//             <Route path='/my-account/customer-download' element={CustomerDownloads} />
